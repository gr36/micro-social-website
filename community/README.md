...
workflow in `.github/workflows/update-community.yml`, which needs a `MICROBLOG_TOKEN` secret; an optional `COMMUNITY_EXCLUDE` secret lists accounts, comma-separated, that are never shown),
