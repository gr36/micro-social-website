...
The desk lives in its own repository, [micro-wrapped-desk](https://github.com/gr36/micro-wrapped-desk). Double-click its launcher and it writes editions into this repository and pushes them.
